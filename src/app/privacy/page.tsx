  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-indigo-400 mb-2">2. Information We Collect</h2>
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-indigo-400 mb-2">3. How We Use Your Information</h2>
          <ul className="list-disc list-inside ml-4 text-gray-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-indigo-400 mb-2">4. How We Share Your Information</h2>
          <ul className="list-disc list-inside ml-4 text-gray-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-indigo-400 mb-2">5. Data Security</h2>
          <p className="text-gray-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-indigo-400 mb-2">6. Data Retention</h2>
          <p className="text-gray-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-indigo-400 mb-2">7. Children's Privacy</h2>
          <p className="text-gray-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-indigo-400 mb-2">8. International Users</h2>
          <p className="text-gray-300">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-indigo-400 mb-2">9. Changes to This Policy</h2>
          <p className="text-gray-300">

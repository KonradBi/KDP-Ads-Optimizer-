...
const TestimonialSection = () => {
  ...
  return (
    <div className="py-12 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-900/60 via-slate-900 to-slate-900">
  ...
  return (
    <>
      <main className="flex min-h-screen flex-col items-center overflow-x-hidden bg-[#232F3E]">
        {/* Hero Section */}
        <section className="relative w-full pt-20 pb-16 px-4 md:px-6 lg:pt-32 lg:pb-24 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-900/60 via-slate-900 to-slate-900 overflow-hidden">
        ...
        {/* Feature Section 1 */}
        <section id="features" className="w-full py-20 px-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-900/60 via-slate-900 to-slate-900 overflow-hidden">
          <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <section className="w-full py-20 px-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-900/60 via-slate-900 to-slate-900">
        ...
        {/* How It Works */}
        <section id="how-it-works" className="py-16 lg:py-24 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-900/60 via-slate-900 to-slate-900 overflow-hidden">
        ...
        {/* FAQ Section */}
        <section id="faq" className="w-full py-20 px-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-900/60 via-slate-900 to-slate-900 overflow-hidden">
